class Zmax < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/MenkeTechnologies/zmax/releases/download/v0.4.29/zemacs-v0.4.29-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/MenkeTechnologies/zmax/releases/download/v0.4.29/zemacs-v0.4.29-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "6b2137e56d512dfb6958979fa99954b4e37e751f70f0cf1fd1eb196ee205c684"
    end
    on_arm do
      url "https://github.com/MenkeTechnologies/zmax/releases/download/v0.4.29/zemacs-v0.4.29-aarch64-unknown-linux-gnu.tar.gz"
